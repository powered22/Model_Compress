"""
run_phase1_zeroshot.py
Phase 1 launcher: zeroshot experiments across all tasks.

Usage:
    python run_phase1_zeroshot.py
    python run_phase1_zeroshot.py --model mistral:7b-instruct-v0.2-q2_K
    python run_phase1_zeroshot.py --tasks weather,extreme
    python run_phase1_zeroshot.py --max-samples 10
"""
...
# ── Argument parsing ──────────────────────────────────────────────────────────
def parse_args():
    parser = argparse.ArgumentParser(description="Phase 1 — Zeroshot experiments")
...
def main():
    ...
    task_map = {
        "weather": ("experiments.run_all_weather_exp", "weather forecasting"),
        "extreme": ("experiments.run_all_extreme_exp", "extreme weather detection"),
        "energy":  ("experiments.run_all_energy_exp",  "energy (forecast + extreme)"),
    }
